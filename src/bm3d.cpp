...
,   unsigned nb_threads
    ...
    if (nb_threads == 1)
    {
        ...
        bm3d_1st_step(sigma, img_sym_noisy, img_sym_basic, w_b, h_b, chnls, nHard,
                      kHard, NHard, pHard, useSD_h, color_space, tau_2D_hard, lambdaHard3D,
                                    ...
                                    plan_2d_for_1, plan_2d_for_2, plan_2d_inv)
        {
            ...
            for (int n = 0; n < nb_threads; n++)
            {
                bm3d_1st_step(sigma, sub_noisy[n], sub_basic[n], w_table[n],
                              ...
                              color_space, tau_2D_hard, lambdaHard3D,
                              &plan_2d_for_1[n], &plan_2d_for_2[n], &plan_2d_inv[n]);
            }
        }
 ...
 * @param nHW: size of the boundary of img, also half of the search window
...
//! Convenience used in precompute_BM
